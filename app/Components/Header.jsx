...
const Header = () => {
  return (
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      >
        I specialize in frontend development, skilled in React.js, Next.js, and
        Node.js. I create responsive, user-friendly applications and strive for
